...
function Footer() {
  ...
  return (
    <footer className="relative overflow-hidden border-t border-white/10 bg-zinc-900 text-white/90">
      ...
      <div className="mx-auto grid w-full max-w-7xl gap-12 px-6 py-10 lg:grid-cols-5 lg:px-8">
        
        {/* Brand Column */}
        <div className="lg:col-span-2">
          <img src="/logo.jpeg" alt="STMCZ Logo" className='h-10 w-10 border border-yellow-500/70 rounded-md'/>
          <p className="mt-2 text-[10px] font-bold uppercase tracking-[0.3em] text-white/60">
            Dual-Discipline Specialists
          </p>
          <p className="mt-2 max-w-sm text-sm leading-5 text-white/70">
        ...
        <div>
          ...
          <div className="mt-6 space-y-5 text-sm">
            ...
            <div className="flex items-center gap-4 text-white/70">
              <div className="flex h-8 w-20 items-center justify-center rounded-full bg-white/5">
